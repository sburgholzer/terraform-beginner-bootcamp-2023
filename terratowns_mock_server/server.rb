...
# let this generic class utilize the Sinatra web-framework
class TerraTownsMockServer < Sinatra::Base
  ...
  post '/api/u/:user_uuid/homes' do
    ensure_correct_headings() # parentheses not necessary, but it helps visually represent it is a function
    ...
    # return the errors
    unless home.valid?
      # returns the errors message as json
...
# This is what will run ther server.
